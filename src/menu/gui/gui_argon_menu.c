...
*/
	...
	if (emuNAND != 0)
	{
		gui_menu_append_entry(menu,gui_create_menu_entry("",sd_file_read("atmosphere/boot_menu/gfx/button.bmp"),buttonX + 10,buttonY - 500, buttonH, buttonW,tool_emu, NULL));
